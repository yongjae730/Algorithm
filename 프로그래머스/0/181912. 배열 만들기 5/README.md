...
슬라이싱 문제라고 생각해 자바의 슬라이싱 방식을 잘 몰라 찾아본게 먼저임
parseInt와 substring을 사용해 s부터 s+l 까지 파싱을 진행하고 숫자 비교,

### 다른 방식

stream을 사용하면 더 간결하게 문제를 풀 수 있음. 근데 이건 차후 실력상승하고 재시도할것



### 성능 요약

메모리: 102 MB, 시간: 5.51 ms
