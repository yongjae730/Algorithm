...
### 최초 접근방식
- 시간이 0시이면서 45분 이상인 경우 혹은 미만인 경우를 판단하고 -> 0시가 아닌경우 판단하려 했음

### 개선방식
- 조건문을 적다가 44분 이하에서만 0시를 고려하면 된다는점을 깨닫고 수정후 문제풀이
### 추후 개선할점
- 프린트를 그냥 저렇게 하면 되는게 맞나? 싶어서 찾아볼예정
